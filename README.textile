...
@wget --no-check-certificate https://github.com/jonathonw/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/jonathonw/oh-my-zsh.git ~/.oh-my-zsh@
